# Analysis of filtered MM cells from 18 samples using seurat.
...
data_1 <- Read10X(data.dir = "../MM01_D_tumor")
data_2 <- Read10X(data.dir = "../MM02_D_tumor")
data_3 <- Read10X(data.dir = "../MM03_D_tumor")
data_4 <- Read10X(data.dir = "../MM04_D_tumor")
data_5 <- Read10X(data.dir = "../MM05_D_tumor")
data_6 <- Read10X(data.dir = "../MM06_D_tumor")
data_7 <- Read10X(data.dir = "../MM07_D_tumor")
data_8 <- Read10X(data.dir = "../MM08_D_tumor")
data_9 <- Read10X(data.dir = "../MM09_D_tumor")
data_10 <- Read10X(data.dir = "../MM10_D_tumor")
data_11 <- Read10X(data.dir = "../MM11_D_tumor")
data_12 <- Read10X(data.dir = "../MM12_D_tumor")

data_13 <- Read10X(data.dir = "../MM13_R_tumor")
data_14 <- Read10X(data.dir = "../MM14_R_tumor")
data_15 <- Read10X(data.dir = "../MM15_R_tumor")
data_16 <- Read10X(data.dir = "../MM16_R_tumor")
data_17 <- Read10X(data.dir = "../MM17_R_tumor")
data_18 <- Read10X(data.dir = "../MM18_R_tumor")
...
for (i in 1:length(data_list)) {
  ...
  data_list[[i]] <- subset(data_list[[i]], subset =  percent.mt <10 & HBB < 2 & nCount_RNA > 2000)
...
saveRDS(data.integrated,file = "../CCA18.rds")